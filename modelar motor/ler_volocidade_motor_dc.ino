...
double diskslots = 20;  // Change to match value of encoder disk
...
void ISR_timerone()
{
  ...
  Serial.print(", ");
  float rotation1 = (counter1 / diskslots) * 600.00;  // calculate RPM for Motor 1
  Serial.print(rotation1, 2);
  Serial.println(", ");  
  //Serial.print(" RPM - "); 
  counter1 = 0;  //  reset counter to zero
  //Serial.print("Motor Speed 2: "); 
  float rotation2 = (counter2 / diskslots) * 600.00;  // calculate RPM for Motor 2
